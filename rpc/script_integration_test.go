...
func TestTorrentManager_ScriptHooks_TorrentAdded(t *testing.T) {
	...
	// Add a torrent to trigger the script
	req := TorrentAddRequest{
		Metainfo: "ZDg6YW5ub3VuY2U5OnRlc3QtdHJhY2tlcjQ6aW5mb2Q0Om5hbWUxNjp0ZXN0LXRvcnJlbnQudHh0MTI6cGllY2UgbGVuZ3RoaTMyNzY4ZTY6bGVuZ3RoaTEwMjQwMDBlZWU=", // base64 encoded bencode
		Paused:   false,
	}
...
func TestTorrentManager_ScriptHooks_TorrentCompleted(t *testing.T) {
	...
	// Add a torrent
	req := TorrentAddRequest{
		Metainfo: "ZDg6YW5ub3VuY2U5OnRlc3QtdHJhY2tlcjQ6aW5mb2Q0Om5hbWUxNjp0ZXN0LXRvcnJlbnQudHh0MTI6cGllY2UgbGVuZ3RoaTMyNzY4ZTY6bGVuZ3RoaTEwMjQwMDBlZWU=", 
...
`
	...
	// Verify script was killed around timeout duration (allow some tolerance)
	if duration > 2*time.Second {
		t.Errorf("Script execution took too long: %v (expected around 1s)", duration)
	}
}
